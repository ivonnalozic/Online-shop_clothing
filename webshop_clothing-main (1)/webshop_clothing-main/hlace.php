...
<body>
<header style="background-color:#b2b2b2;height:60px;">
<?php if( isset($_SESSION['ime']) && !empty($_SESSION['ime']) )
  ...
  <div class="col-9" style="">
    <h3 style="padding-left:100px;text-align:center;color:white;font-family:verdana;font-size:300%">Hlače</h3>
  </div>
</div>
...
<div class="categories1">
            ...
            <div class="categories-container">
                <div class="category1">
                    ...
                    <img src="slike/maja.png" alt="">
                    <div class="category-body">
                        <span> <button class="btn-show-all" type="button" onclick="window.open('majica.php','_self');">Majice</button><span>
                    </div>
                </div>

                <div class="category1">

                    <img src="slike/hlace.jpg" alt="">
                    <div class="category-body">
                        <span> <button class="btn-show-all" type="button" onclick="window.open('hlace.php','_self');">Hlače</button><span>
                    </div>
           </div>
...
<?php if( isset($_SESSION['ime']) && !empty($_SESSION['ime']) )
 ...
 <div class="row">
 <?php
  $result = $con->query("SELECT * FROM proizvod WHERE id>=4 && id<=6 ORDER BY id ASC"); 
        ...
        <div class="col-md-4 mt-2" style="width:320px; height:300px;">
            <div class="card">
                ...
                <div class="card-body bg-light text-center">
                    ...
                    <a href="cartAction.php?action=addToCart&id=<?php echo $row["id"]; ?>" class="btn btn-primary" style="background-color:#6d5454; border:none;width:172px; height:44px;line-height:30px;">Dodaj u listu</a>
                </div>
            </div>
        </div>
...
<div class="container d-flex justify-content-center mt-50 mb-50">
    <div class="row">
        <div class="col-md-4 mt-2" style="width:320px; height:300px;">
            <div class="card">
                <div class="card-body">
                    <div class="card-img-actions"> <img src="slike/jeans1.jpg" style="width:250px; height:300px;" class="card-img img-fluid" width="96" height="350" alt=""> </div>
                </div>
                <div class="card-body bg-light text-center">
                    <div class="mb-2">
                        <h6 class="font-weight-semibold mb-2"> <a href="#" class="text-default mb-2" data-abc="true" style="color:black;">NAZIV: Traperice Mom kroja S</a> </h6> <a href="#" class="text-muted" data-abc="true"></a>
                    </div>
                    <h6 class="mb-0 font-weight-semibold">CIJENA:50 KM</h6>
...
$(document).ready(function(){
  $('[data-toggle="popover"]').popover();
                    ...
                    <button type="button" class="btn bg-cart" style=" background-color:#6d5454; border:none;width:172px; height:44px;line-height:30px;" data-toggle="popover" title="Morate se prijaviti/registrirati"><i class="fa fa-cart-plus mr-2"></i> Dodaj u listu</button>
                </div>
            </div>
        </div>
        <div class="col-md-4 mt-2" style="width:320px; height:280px;">
            <div class="card">
                <div class="card-body">
                    <div class="card-img-actions"> <img src="slike/jeansrasp1.jpg" style="width:250px; height:300px;" class="card-img img-fluid" width="96" height="350" alt=""> </div>
                </div>
                <div class="card-body bg-light text-center">
                    <div class="mb-2">
                        <h6 class="font-weight-semibold mb-2"> <a href="#" class="text-default mb-2" data-abc="true" style="color:black;">NAZIV: Duge traperice sirokih nogavica</a> </h6> <a href="#" class="text-muted" data-abc="true"></a>
                    </div>
                    <h6 class="mb-0 font-weight-semibold">CIJENA: 60 KM</h6>
                    <div> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> </div>
                    <div class="text-muted mb-3"></div> 
                    <script>
$(document).ready(function(){
  $('[data-toggle="popover"]').popover();
        ...
        <div class="col-md-4 mt-2" style="width:320px; height:300px;">
            <div class="card">
                <div class="card-body">
                    <div class="card-img-actions"> <img src="slike/tamnad1.jpg" style="width:250px; height:300px;" class="card-img img-fluid" width="96" height="350" alt=""> </div>
                </div>
                <div class="card-body bg-light text-center">
                    <div class="mb-2">
                        <h6 class="font-weight-semibold mb-2"> <a href="#" class="text-default mb-2" data-abc="true" style="color:black;">NAZIV:Traperice Tamne</a> </h6> <a href="#" class="text-muted" data-abc="true"></a>
                    </div>
                    <h6 class="mb-0 font-weight-semibold">CIJENA: 35 KM</h6>
                    <div> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> </div>
                    <div class="text-muted mb-3"></div>
                    <script>
$(document).ready(function(){
