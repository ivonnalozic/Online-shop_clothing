...
<?php if( isset($_SESSION['ime']) && !empty($_SESSION['ime']) )
  ...
  <div class="col-9" style="">
    <h3 style="padding-left:100px;text-align:center;color:white;font-family:verdana;font-size:300%">Majice i košulje</h3>
  </div>
</div>
...
<div class="container d-flex justify-content-center mt-50 mb-50">
    <div class="row">
        <div class="col-md-4 mt-2" style="width:320px; height:300px;">
            <div class="card">
                <div class="card-body">
                    <div class="card-img-actions"> <img src="slike/sarena1.jpg" style="width:250px; height:300px;" class="card-img img-fluid" width="96" height="350" alt=""> </div>
                </div>
                <div class="card-body bg-light text-center">
                    <div class="mb-2">
                        <h6 class="font-weight-semibold mb-2"> <a href="#" class="text-default mb-2" data-abc="true" style="color:black;">NAZIV: Majica s natpisom</a> </h6> <a href="#" class="text-muted" data-abc="true"></a>
                    </div>
                    <h6 class="mb-0 font-weight-semibold">CIJENA:45 KM</h6>
...
$(document).ready(function(){
  $('[data-toggle="popover"]').popover();
        ...
        <div class="col-md-4 mt-2" style="width:320px; height:280px;">
            <div class="card">
                <div class="card-body">
                    <div class="card-img-actions"> <img src="slike/kosulja1.jpg" style="width:250px; height:300px;" class="card-img img-fluid" width="96" height="350" alt=""> </div>
                </div>
                <div class="card-body bg-light text-center">
                    <div class="mb-2">
                        <h6 class="font-weight-semibold mb-2"> <a href="#" class="text-default mb-2" data-abc="true" style="color:black;">NAZIV: Košulja od Denima</a> </h6> <a href="#" class="text-muted" data-abc="true"></a>
                    </div>
                    <h6 class="mb-0 font-weight-semibold">CIJENA: 37 KM</h6>
                    <div> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> </div>
                    <div class="text-muted mb-3"></div> 
                    <script>
$(document).ready(function(){
  $('[data-toggle="popover"]').popover();
        ...
        <div class="col-md-4 mt-2" style="width:320px; height:300px;">
            <div class="card">
                <div class="card-body">
                    <div class="card-img-actions"> <img src="slike/lila1.jpg" style="width:250px; height:300px;" class="card-img img-fluid" width="96" height="350" alt=""> </div>
                </div>
                <div class="card-body bg-light text-center">
                    <div class="mb-2">
                        <h6 class="font-weight-semibold mb-2"> <a href="#" class="text-default mb-2" data-abc="true" style="color:black;">NAZIV: Jakna</a> </h6> <a href="#" class="text-muted" data-abc="true"></a>
                    </div>
                    <h6 class="mb-0 font-weight-semibold">CIJENA: 40 KM</h6>
                    <div> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> <i class="fa fa-star star"></i> </div>
                    <div class="text-muted mb-3"></div>
                    <script>
$(document).ready(function(){
